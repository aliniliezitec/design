          ...
          <div [formGroup]="formGroup1">
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-center no-gutters">
                ...
                <div class="col">
                  <input [ngClass]="{'is-invalid': !(formGroup1.get('legalName').pristine || formGroup1.get('legalName').disabled || formGroup1.get('legalName').valid)}" autocomplete="off" class="form-control nao-mw-0 nao-mw-sm-250"
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-center no-gutters">
                ...
                <div class="col">
                  <input [ngClass]="{'is-invalid': !(formGroup1.get('address_line_1').pristine || formGroup1.get('address_line_1').disabled || formGroup1.get('address_line_1').valid)}" autocomplete="off" class="form-control nao-mw-0 nao-mw-sm-250"
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-center no-gutters">
                ...
                <div class="col">
                  <input autocomplete="off" class="form-control nao-mw-0 nao-mw-sm-250" formControlName="address_line_2"
            ...
            <div class="mb-3">
              ...
              <div class="d-flex flex-column flex-sm-row align-items-center no-gutters">
                ...
                <div class="col">
                  <input autocomplete="off" class="form-control nao-mw-0 nao-mw-sm-250" formControlName="phone"
                         placeholder="Address" type="text"/>
                </div>
              </div>
            </div>
    ...
    <div class="nao-crm-free-trial-form bg-white">
          <form [formGroup]="formGroup3">
            ...
            <div class="form-group mb-3">
              ...
              <ng-select [clearable]="false" [multiple]="false" bindLabel="name" bindValue="value" class="nao-ng-select-sm mb-1"
